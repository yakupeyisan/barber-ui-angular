...
@Component({
    ...
    standalone   : true,
    imports      : [BarberLoadingBarComponent, BarberVerticalNavigationComponent, UserComponent, NgIf, MatIconModule, MatButtonModule, LanguagesComponent, BarberFullscreenComponent,  RouterOutlet],
})
