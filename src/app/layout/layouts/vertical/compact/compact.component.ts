...
@Component({
    ...
    standalone   : true,
    imports      : [BarberLoadingBarComponent, MatButtonModule, MatIconModule, LanguagesComponent, BarberFullscreenComponent, UserComponent, NgIf, RouterOutlet, BarberVerticalNavigationComponent],
})
