...
@Component({
    ...
    standalone   : true,
    imports      : [BarberLoadingBarComponent, BarberVerticalNavigationComponent, MatButtonModule, MatIconModule, LanguagesComponent, BarberFullscreenComponent, UserComponent, NgIf, RouterOutlet],
})
