...
@Component({
    ...
    standalone   : true,
    imports      : [BarberLoadingBarComponent, NgIf, BarberVerticalNavigationComponent, MatButtonModule, MatIconModule, LanguagesComponent, BarberFullscreenComponent, UserComponent, BarberHorizontalNavigationComponent, RouterOutlet],
})
