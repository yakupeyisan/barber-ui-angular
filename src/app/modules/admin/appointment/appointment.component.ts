...
import { Appointment, AppointmentServiceDto, AppointmentWithUserAndServices } from 'app/core/models';
...
export class AppointmentComponent implements OnInit {
    ...
    getTotalAmount(dto:AppointmentServiceDto[]){
        return dto.map(d=>{return d.amount}).reduce((partialSum, a) => partialSum + a, 0)
    }
