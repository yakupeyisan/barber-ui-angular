...
import { BarberHighlightService } from '@barber/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[barber-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'barberHighlight',
    standalone     : true,
    imports        : [NgClass],
})
export class BarberHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _barberHighlightService: BarberHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._barberHighlightService.highlight(this.code, this.lang));
