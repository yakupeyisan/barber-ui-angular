...
@Component({
    selector       : 'barber-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : barberAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone     : true,
    imports        : [NgClass, MatTooltipModule, NgIf, MatIconModule, NgFor, BarberVerticalNavigationBasicItemComponent, forwardRef(() => BarberVerticalNavigationCollapsableItemComponent), BarberVerticalNavigationDividerItemComponent, BarberVerticalNavigationGroupItemComponent, BarberVerticalNavigationSpacerItemComponent],
})
export class BarberVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any
    {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'barber-vertical-navigation-item-collapsed': this.isCollapsed,
            'barber-vertical-navigation-item-expanded' : this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void
    {
        ...
        this._barberVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._barberVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._barberVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._barberVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _hasActiveChild(item: BarberNavigationItem, currentUrl: string): boolean
    {
     ...
     * @private
     */
    private _isChildrenOf(parent: BarberNavigationItem, item: BarberNavigationItem): boolean
    {
