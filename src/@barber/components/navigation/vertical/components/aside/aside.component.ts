...
@Component({
    selector       : 'barber-vertical-navigation-aside-item',
    templateUrl    : './aside.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone     : true,
    imports        : [NgClass, MatTooltipModule, NgIf, MatIconModule, NgFor, BarberVerticalNavigationBasicItemComponent, BarberVerticalNavigationCollapsableItemComponent, BarberVerticalNavigationDividerItemComponent, BarberVerticalNavigationGroupItemComponent, BarberVerticalNavigationSpacerItemComponent],
})
export class BarberVerticalNavigationAsideItemComponent implements OnChanges, OnInit, OnDestroy
{
