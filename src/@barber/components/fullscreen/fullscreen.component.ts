...
import { FSDocument, FSDocumentElement } from '@barber/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'barber-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'barberFullscreen',
    standalone     : true,
    imports        : [MatButtonModule, MatTooltipModule, NgTemplateOutlet, MatIconModule],
})
export class BarberFullscreenComponent implements OnInit
{
