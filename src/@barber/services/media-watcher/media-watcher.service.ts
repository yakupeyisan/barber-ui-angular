...
import { BarberConfigService } from '@barber/services/config';
import { fromPairs } from 'lodash-es';
import { map, Observable, ReplaySubject, switchMap } from 'rxjs';

@Injectable({providedIn: 'root'})
export class BarberMediaWatcherService
{
    ...
    constructor(
        ...
        private _barberConfigService: BarberConfigService,
    )
    {
        this._barberConfigService.config$.pipe(
