...
import { ScrollbarGeometry, ScrollbarPosition } from '@barber/directives/scrollbar/scrollbar.types';
 ...
 */
@Directive({
    selector  : '[barberScrollbar]',
    exportAs  : 'barberScrollbar',
    standalone: true,
})
export class BarberScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_barberScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() barberScrollbar: boolean = true;
    @Input() barberScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'barberScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.barberScrollbar = coerceBooleanProperty(changes.barberScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.barberScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'barberScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.barberScrollbarOptions.currentValue);
