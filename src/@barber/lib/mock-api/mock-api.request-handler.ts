...
import { BarberMockApiReplyCallback } from '@barber/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class BarberMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: BarberMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: BarberMockApiReplyCallback): void
    {
        // Store the reply
